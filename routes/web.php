...
use App\Http\Controllers\User\UsersHomeController;
use App\Http\Controllers\User\WishlistController;
use App\Http\Controllers\User\PaymentController;
use App\Http\Controllers\User\PaypalController;
// use App\Http\Controllers\User\OrderController;

use App\Http\Controllers\Agents\Auth\AgentLoginController;
use App\Http\Controllers\Agents\Auth\AgentForgotPasswordController;
use App\Http\Controllers\Agents\AgentDashboardController;
use App\Http\Controllers\Agents\AgentOrderController;


use App\Http\Controllers\Agents\AgentPropertyController;
use App\Http\Controllers\Agents\AgentHomeController;
use App\Http\Controllers\Agents\PaymentsController;
use App\Http\Controllers\Agents\OrderController;
use App\Http\Controllers\Agents\UserHomeController;
...
Route::get('/all-properties',[HomeController::class,'allProperties'])->name('all-properties');
Route::get('/prop-auction',[HomeController::class,'propAuction'])->name('prop-auction');
Route::get('/prop-own',[HomeController::class,'propOwn'])->name('prop-own');


Route::post('/property-table-search',[HomeController::class,'propertyTableSearch'])->name('property-table');

Route::post('/property-auction-search',[HomeController::class,'propertyNonAuctionTableSearch'])->name('property-non-auction-search');
...
Route::post('price-search',[HomeController::class,'pricesearch'])->name('price-search');


Route::post('input-search',[HomeController::class,'inputsearch'])->name('input-search');
...
Route::post('property-ajax',[HomeController::class,'property'])->name('get-property');

Route::post('city-ajax',[HomeController::class,'getcity'])->name('get-city');
Route::post('locality-ajax',[HomeController::class,'getlocality'])->name('get-locality');


Route::get('/all-vehicles',[HomeController::class,'allVehicles'])->name('all-vehicles');

Route::post('vehicles-table-search',[HomeController::class,'vehiclestablesearch'])->name('vehicles-table');
Route::post('vehicles-non-auction-search',[HomeController::class,'vehiclesNonAuctiontablesearch'])->name('vehicles-non-auction-search');
...
Route::group(['as'=> 'user.', 'prefix' => 'user'],function (){
    ...
    //document
    Route::post('user-enquiry',[HomeController::class,'userEnqlist'])->name('ajax-enquiry');

    Route::post('document',[HomeController::class,'documentstore'])->name('documentstore');
    Route::post('enquiry',[HomeController::class,'enquirystore'])->name('user-enquiry');
    Route::get('verifyauction',[HomeController::class,'verifyauction'])->name('verifyauction');
    Route::get('showpaymet',[HomeController::class,'showpaymet'])->name('showpaymet');
    ...
    Route::get('my-review',[UsersHomeController::class,'myReview'])->name('my-review');
    Route::get('delete-review',[UsersHomeController::class,'deleteReview'])->name('delete-review');

    Route::get('client-review',[UsersHomeController::class,'clientReview'])->name('client-review');
    Route::post('store-review',[UsersHomeController::class,'storeReview'])->name('store-review');
    Route::get('edit-review/{id}',[UsersHomeController::class,'editReview'])->name('edit-review');
    Route::post('update-review/{id}',[UsersHomeController::class,'updateReview'])->name('update-review');
    Route::get('delete-review/{id}',[UsersHomeController::class,'deleteReview'])->name('delete-review');
    Route::get('my-profile',[UsersHomeController::class,'profile'])->name('my-profile');
    Route::post('update-profile',[UsersHomeController::class,'updateProfile'])->name('update.profile');
    Route::post('update-password',[UsersHomeController::class,'updatePassword'])->name('update.password');
    Route::post('update-profile-banner',[UsersHomeController::class,'updateProfileBanner'])->name('update.profile.banner');
    ...
    Route::get('package',[UsersHomeController::class,'ListingPackage'])->name('package');
    ...
    Route::get('my-auction',[HomeController::class,'auction'])->name('auction');
    Route::post('auction',[HomeController::class,'auctionlist'])->name('ajax-auction');

    Route::post('auction-enq',[HomeController::class,'auctionEnqlist'])->name('ajax-auction-enq');

    

Route::post('payment',[PaymentController::class,'order'])->name('payment');
Route::post('payment/status',[PaymentController::class,'PaytmPaymentCallback'])->name('status');
...
Route::get('donwload-file',[AdminDashboardController::class,'admindonwloadFile'])->name('admin-donwload-file');

//agent profile section 
Route::group(['as'=> 'agents.', 'prefix' => 'agents'],function (){

    Route::get('donwload-file',[AgentHomeController::class,'donwloadFile'])->name('donwload-file');
    
Route::get('dashboard',[AgentDashboardController::class,'index'])->name('dashboard');

Route::get('/',[AgentLoginController::class,'AgentLoginForm'])->name('login');
Route::get('login',[AgentLoginController::class,'AgentLoginForm'])->name('login');
...
Route::get('my-order',[AgentOrderController::class,'index'])->name('my-order');
Route::get('order-details/{id}',[AgentOrderController::class,'show'])->name('order.details');
...
Route::post('auction',[AgentHomeController::class,'auctionlist'])->name('ajax-auction');

Route::post('auction-enq',[AgentHomeController::class,'auctionEnqlist'])->name('ajax-auction-enq');



Route::get('dashboard',[DashboardController::class,'dashboard'])->name('dashboard');
Route::get('my-properties',[AgentPropertyController::class,'index'])->name('my.properties');
Route::get('delete-property/{id}',[AgentPropertyController::class,'destroy'])->name('property.delete');
Route::get('my-profile',[AgentHomeController::class,'profile'])->name('my-profile');
Route::post('update-profile',[AgentHomeController::class,'updateProfile'])->name('update.profile');
Route::post('update-password',[AgentHomeController::class,'updatePassword'])->name('update.password');
Route::post('update-profile-banner',[AgentHomeController::class,'updateProfileBanner'])->name('update.profile.banner');

Route::get('my-order',[OrderController::class,'index'])->name('my-order');
Route::get('/pricing-plan',[UserHomeController::class,'pricingPlan'])->name('pricing.plan');
Route::get('order-details/{id}',[OrderController::class,'show'])->name('order.details');

Route::get('create-property',[AgentPropertyController::class,'create'])->name('create.property');

Route::get('my-auction',[AgentHomeController::class,'auction'])->name('auction');
Route::post('razorpay-payment',[PaymentsController::class,'razorPayment'])->name('razorpay');




Route::get('event-registration',[PaymentsController::class,'register']);
Route::post('payment',[PaymentsController::class,'order'])->name('payment');
Route::post('payment/status',[PaymentsController::class,'paymentCallback'])->name('status');

Route::post('store-agents',[AgentPropertyController::class,'store'])->name('store.agents');
Route::get('agents-edit/{id}',[AgentPropertyController::class,'edit'])->name('agents.edit');
Route::post('update-agent/{id}',[AgentPropertyController::class,'update'])->name('agent.update');


Route::get('importfile',[HomeController::class,'import'])->name('importcreate');
Route::post('import',[HomeController::class,'uploadProperty'])->name('import');
...
Route::post('otp-verify',[RegisterController::class,'otpgenerater'])->name('otp-verify');
Route::post('confirmation',[RegisterController::class,'confirmation'])->name('confirmation');
Route::get('otp-verification',[RegisterController::class,'otp_verification'])->name('otp-verification');
Route::get('registration',[RegisterController::class,'registration'])->name('registration');
Route::get('create-password',[RegisterController::class,'create_password'])->name('create-password');
Route::post('create-dashboard',[RegisterController::class,'dashboard'])->name('password-dashboard');
...
Route::get('loginguser',[LoginController::class,'redirectToGoogle'])->name('logingoogle');
Route::get('google/callback',[LoginController::class,'loginwithgoogle'])->name('callback');


Route::get('auth', [LoginController::class, 'loginUsingFacebook'])->name('facebooklogin');
Route::get('facebook/callback', [LoginController::class, 'callbackFromFacebook'])->name('callback');
...
Route::group(['as'=> 'admin.', 'prefix' => 'admin'],function (){
    ...
    Route::get('role-status/{id}',[RolePermissionController::class,'roleStatus'])->name('role.status');

    Route::get('bank-details',[BankController::class,'bankdetails'])->name('bank-details');

    Route::post('bank-details-update/{id}',[BankController::class,'bankUpdate'])->name('bank-details-update');

    

    Route::get('role-delete/{id}',[RolePermissionController::class,'destroy'])->name('role.delete');
    ...
    Route::post('paytm-update/{id}',[PaymentAccountController::class,'paytmUpdate'])->name('paytm-update');
    ...
    Route::get('whatsapp-setting',[SettingsController::class,'whatsappSetting'])->name('whatsapp.setting');

    Route::post('update-captcha-setting',[SettingsController::class,'updateCaptchaSetting'])->name('update.captcha.setting');

    Route::post('update-whatsapp-setting',[SettingsController::class,'updateWhatsappSetting'])->name('update.whatsapp.setting');
    ...
    // bult route 
    Route::get('importfile',[AdminPropertyController::class,'import'])->name('importcreate');
    Route::post('import',[AdminPropertyController::class,'uploadProperty'])->name('import');
    ...
    Route::post('ajax-property',[AdminPropertyController::class,'propertyAjax'])->name('ajax.property');
    ...
    //customer kyc
    Route::get('customer-status/{id}',[UserController::class,'customerStatus'])->name('customer.status');
    Route::get('customer-delete/{id}',[UserController::class,'customerDelete'])->name('customer.delete');
    Route::get('customer-enquiry-delete/{id}',[UserController::class,'enquiryDelete'])->name('customer.enquiry.delete');
    Route::get('customer-kyc',[UserController::class,'totalKyc'])->name('customer-kyc');
    Route::get('kyc-customer-show/{id}',[UserController::class,'kycCustomerShow'])->name('kyc.customer.show');

    Route::get('customer-enquiry-show/{id}',[UserController::class,'customerEnquiryShow'])->name('customer.enquiry.show');


    Route::get('customer-show/{id}',[UserController::class,'customershow'])->name('customer.show');

     //bank page 
    Route::get('bank',[BankController::class,'index'])->name('bank');
    Route::get('bank-show/{id}',[BankController::class,'bankshow'])->name('bank.show');
    Route::get('bank-status/{id}',[BankController::class,'bankStatus'])->name('bank.status');
